...
<template>
  <div class="Singer content-width">
    ...
    <singer-list @changePage="changePage"
                 :pageDown="pageDown"
                 :pageUp="pageUp"
                 :singerList="singerList"></singer-list>

  </div>
</template>

<script>
import SingerFilter from "components/common/singer/singerFilter/SingerFilter";
