  ...
  <div id="AlbumDetailsList"
    ...
    <div class="list">
      <music-list @getMusic="getMusic"
                  :musicList="albumMusic"></music-list>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return { isShowDescribe: false, descHeight: null };
  },
  props: {
    album: {
      type: Object,
