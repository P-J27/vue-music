...
<template>
  <div id="MvList">
    <ul class="list">
      <li @click="toDetails(item.id)"
        ...
        <div class="img">
          ...
          <el-image :src="mvAttr == 'default'?item.cover:item.imgurl"
          ...
          <div class="smoke">
            ...
            <div>
              <span
                    class="playCount"><i>点击：</i>{{item.playCount | tranNumber(that)}}</span>
              <span class="playTime">{{item.duration | formatTime(that)}}</span>
    ...
    <div class="page"
         v-if="mvType =='default'?true:false">
      <el-button type="info"
                 @click="changePage('up')"
                 plain
